				...
				<div class="row">
					<div class="col-md-12 panel-info">
						<div class="content-box-header panel-heading">
							<div class="panel-title ">Sửa phòng ban</div>
						</div>
						<div class="content-box-large box-with-header">
							<div>
								<div class="row mb-10"></div>
								<div class="row">
									<form action="<%=request.getContextPath()%>/phongban/edit" method="post">
										<div class="col-sm-6">
											<div class="form-group">
												<label for="id">ID</label> <input type="text"
													class="form-control" placeholder="Nhập id" name="id" value="<%=phongBan.getId()%>">
											</div>
											<div class="form-group">
												<label for="name">Tên</label> <input type="text"
													class="form-control" placeholder="Nhập tên phòng ban"
													name="name" value="<%=phongBan.getName()%>">
											</div>
											<hr>
											<div class="row">
												<div class="col-sm-12">
